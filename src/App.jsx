...
// ──────────────────────────────────────────────────
// MATCH DATA — sourced from tennisstats.com, March 11 2026
// ──────────────────────────────────────────────────
const MOCK_MATCHES = [
  // ════ INDIAN WELLS ATP MASTERS 1000 ════
  {
    id:1, circuit:"ATP", level:"Masters 1000", tournament:"Indian Wells Masters", surface:"Hard", round:"R16",
    status:"PRE", game:"-", point:"-", startTime:"Today 21:00", updated:Date.now()-300000,
    p1:{...BP,name:"C. Alcaraz",rank:1,flag:"🇪🇸",age:22,hand:"R",
      tiebreak_wr:0.64,third_set_wr:0.70,bp_convert:53,style:"allcourt",
      fatigue:0.18,momentum:0.6,h2h:"4-1",recent_form:[1,1,1,0,1],
      surface_wr:0.81,travel_hrs:9,last_match_days:2,altitude_delta:450,sleep_zone_diff:9},
    p2:{...BP,name:"C. Ruud",rank:13,flag:"🇳🇴",age:25,hand:"R",
      tiebreak_wr:0.48,third_set_wr:0.54,bp_convert:44,style:"baseline",
      fatigue:0.14,momentum:0.3,h2h:"1-4",recent_form:[1,1,0,1,0],
      surface_wr:0.62,travel_hrs:12,last_match_days:2,altitude_delta:0,sleep_zone_diff:1},
    odds:{pinnacle:{p1:1.27,p2:3.95},epicbet:{p1:1.29,p2:3.80},bet365:{p1:1.30,p2:3.70},unibet:{p1:1.32,p2:3.60},
          williamhill:{p1:1.28,p2:3.85},betway:{p1:1.30,p2:3.72},bwin:{p1:1.31,p2:3.65}},
    markets:[
      {key:"set_hcp",name:"Set Handicap",lines:[
        {p1_label:"Alcaraz -1.5 sets",p2_label:"Ruud +1.5 sets",
         odds:{pinnacle:{p1:1.88,p2:1.92},epicbet:{p1:1.93,p2:1.87},bet365:{p1:1.95,p2:1.85},unibet:{p1:1.90,p2:1.90}}},
      ]},
    ],
  },
  {
    id:2, circuit:"ATP", level:"Masters 1000", tournament:"Indian Wells Masters", surface:"Hard", round:"R16",
    status:"PRE", game:"-", point:"-", startTime:"Today 22:30", updated:Date.now()-180000,
    p1:{...BP,name:"J. Sinner",rank:2,flag:"🇮🇹",age:23,hand:"R",
      ...
      fatigue:0.20,momentum:0.5,h2h:"3-0",recent_form:[1,1,1,1,0],
      surface_wr:0.80,travel_hrs:11,last_match_days:2,altitude_delta:450,sleep_zone_diff:9},
    p2:{...BP,name:"J. Fonseca",rank:35,flag:"🇧🇷",age:18,hand:"R",
      aces:4,df:2,first_pct:65,first_won:68,second_won:44,bp_saved:58,bp_faced:4,service_games:7,return_pts_won:38,
      tiebreak_wr:0.50,third_set_wr:0.48,bp_convert:38,style:"aggressive",
      fatigue:0.10,momentum:0.7,h2h:"0-3",recent_form:[1,1,0,1,1],
      surface_wr:0.62,travel_hrs:14,last_match_days:2,altitude_delta:450,sleep_zone_diff:6},
    odds:{pinnacle:{p1:1.18,p2:5.20},epicbet:{p1:1.20,p2:5.00},bet365:{p1:1.22,p2:4.80},unibet:{p1:1.23,p2:4.60},
          williamhill:{p1:1.19,p2:5.10},betway:{p1:1.21,p2:4.90},bwin:{p1:1.22,p2:4.75}},
    markets:[
      {key:"set_hcp",name:"Set Handicap",lines:[
        {p1_label:"Sinner -1.5 sets",p2_label:"Fonseca +1.5 sets",
         odds:{pinnacle:{p1:1.60,p2:2.35},epicbet:{p1:1.63,p2:2.28},bet365:{p1:1.65,p2:2.25},unibet:{p1:1.62,p2:2.30}}},
      ]},
    ],
  },
  {
    id:3, circuit:"ATP", level:"Masters 1000", tournament:"Indian Wells Masters", surface:"Hard", round:"R16",
    status:"PRE", game:"-", point:"-", startTime:"Today 20:00", updated:Date.now()-240000,
    p1:{...BP,name:"D. Medvedev",rank:11,flag:"🇷🇺",age:29,hand:"R",
      aces:5,df:2,first_pct:68,first_won:73,second_won:50,bp_saved:70,bp_faced:4,service_games:8,return_pts_won:42,
      tiebreak_wr:0.72,third_set_wr:0.58,bp_convert:42,style:"counter",
      fatigue:0.16,momentum:0.4,h2h:"3-0",recent_form:[1,0,1,1,1],
      surface_wr:0.70,travel_hrs:11,last_match_days:2,altitude_delta:450,sleep_zone_diff:9},
    p2:{...BP,name:"A. Michelsen",rank:44,flag:"🇺🇸",age:22,hand:"R",
      aces:3,df:2,first_pct:63,first_won:68,second_won:47,bp_saved:55,bp_faced:4,service_games:7,return_pts_won:39,
      tiebreak_wr:0.48,third_set_wr:0.50,bp_convert:38,style:"serve-dom",
      fatigue:0.08,momentum:0.4,h2h:"0-3",recent_form:[1,1,0,1,0],
      surface_wr:0.62,travel_hrs:0,last_match_days:2,altitude_delta:450,sleep_zone_diff:0},
    odds:{pinnacle:{p1:1.40,p2:3.05},epicbet:{p1:1.43,p2:2.95},bet365:{p1:1.45,p2:2.88},unibet:{p1:1.47,p2:2.80},
          williamhill:{p1:1.41,p2:3.00},betway:{p1:1.43,p2:2.92},bwin:{p1:1.42,p2:2.98}},
  },
  {
    id:4, circuit:"ATP", level:"Masters 1000", tournament:"Indian Wells Masters", surface:"Hard", round:"R16",
    status:"PRE", game:"-", point:"-", startTime:"Today 18:00", updated:Date.now()-360000,
    p1:{...BP,name:"C. Norrie",rank:29,flag:"🇬🇧",age:29,hand:"L",
      aces:2,df:2,first_pct:62,first_won:66,second_won:48,bp_saved:62,bp_faced:4,service_games:7,return_pts_won:43,
      tiebreak_wr:0.52,third_set_wr:0.55,bp_convert:43,style:"counter",
      fatigue:0.12,momentum:0.2,h2h:"2-0",recent_form:[1,0,1,1,0],
      surface_wr:0.63,travel_hrs:9,last_match_days:2,altitude_delta:450,sleep_zone_diff:8},
    p2:{...BP,name:"R. Hijikata",rank:117,flag:"🇦🇺",age:23,hand:"R",
      aces:3,df:3,first_pct:61,first_won:64,second_won:43,bp_saved:50,bp_faced:4,service_games:6,return_pts_won:36,
  ...
  {
    id:5, circuit:"WTA", level:"WTA 1000", tournament:"Indian Wells Masters (WTA)", surface:"Hard", round:"R16",
    status:"PRE", game:"-", point:"-", startTime:"Today 18:00", updated:Date.now()-420000,
    p1:{...BP,name:"I. Swiatek",rank:2,flag:"🇵🇱",age:23,hand:"R",
      aces:2,df:2,first_pct:68,first_won:72,second_won:55,bp_saved:74,bp_faced:4,service_games:8,return_pts_won:48,
      tiebreak_wr:0.60,third_set_wr:0.66,bp_convert:56,style:"counter",
      fatigue:0.10,momentum:0.6,h2h:"5-1",recent_form:[1,1,1,1,1],
      surface_wr:0.79,travel_hrs:11,last_match_days:2,altitude_delta:450,sleep_zone_diff:9},
    p2:{...BP,name:"K. Muchova",rank:13,flag:"🇨🇿",age:28,hand:"R",
      aces:3,df:2,first_pct:64,first_won:68,second_won:51,bp_saved:62,bp_faced:4,service_games:8,return_pts_won:44,
      tiebreak_wr:0.56,third_set_wr:0.60,bp_convert:48,style:"allcourt",
      fatigue:0.12,momentum:0.4,h2h:"1-5",recent_form:[1,1,0,1,1],
      surface_wr:0.68,travel_hrs:11,last_match_days:2,altitude_delta:450,sleep_zone_diff:9},
    odds:{pinnacle:{p1:1.38,p2:3.15},epicbet:{p1:1.40,p2:3.05},bet365:{p1:1.42,p2:2.95},unibet:{p1:1.44,p2:2.88},
          williamhill:{p1:1.39,p2:3.10},betway:{p1:1.41,p2:3.00},bwin:{p1:1.42,p2:2.92}},
  },
  {
    id:6, circuit:"WTA", level:"WTA 1000", tournament:"Indian Wells Masters (WTA)", surface:"Hard", round:"R16",
    status:"PRE", game:"-", point:"-", startTime:"Today 19:30", updated:Date.now()-480000,
    p1:{...BP,name:"J. Pegula",rank:5,flag:"🇺🇸",age:30,hand:"R",
      aces:2,df:2,first_pct:65,first_won:69,second_won:53,bp_saved:67,bp_faced:4,service_games:8,return_pts_won:44,
      tiebreak_wr:0.55,third_set_wr:0.58,bp_convert:48,style:"aggressive",
      fatigue:0.10,momentum:0.3,h2h:"3-1",recent_form:[1,0,1,1,1],
      surface_wr:0.72,travel_hrs:0,last_match_days:2,altitude_delta:450,sleep_zone_diff:0},
    p2:{...BP,name:"B. Bencic",rank:12,flag:"🇨🇭",age:28,hand:"R",
      aces:3,df:2,first_pct:63,first_won:67,second_won:50,bp_saved:60,bp_faced:4,service_games:7,return_pts_won:43,
  ...
  },
  {
    ...
    status:"PRE", game:"-", point:"-", startTime:"Today 23:30", updated:Date.now()-540000,
    p1:{...BP,name:"E. Rybakina",rank:3,flag:"🇰🇿",age:25,hand:"R",
      aces:5,df:2,first_pct:70,first_won:74,second_won:54,bp_saved:70,bp_faced:4,service_games:9,return_pts_won:42,
      tiebreak_wr:0.64,third_set_wr:0.67,bp_convert:50,style:"serve-dom",
      fatigue:0.14,momentum:0.5,h2h:"4-0",recent_form:[1,1,1,0,1],
      surface_wr:0.76,travel_hrs:11,last_match_days:2,altitude_delta:450,sleep_zone_diff:9},
    p2:{...BP,name:"S. Kartal",rank:54,flag:"🇬🇧",age:23,hand:"R",
      aces:2,df:3,first_pct:60,first_won:63,second_won:46,bp_saved:55,bp_faced:4,service_games:7,return_pts_won:37,
      tiebreak_wr:0.44,third_set_wr:0.46,bp_convert:36,style:"allcourt",
      fatigue:0.10,momentum:0.3,h2h:"0-4",recent_form:[1,0,1,1,0],
      surface_wr:0.55,travel_hrs:9,last_match_days:2,altitude_delta:450,sleep_zone_diff:8},
    odds:{pinnacle:{p1:1.20,p2:4.80},epicbet:{p1:1.22,p2:4.60},bet365:{p1:1.23,p2:4.50},unibet:{p1:1.25,p2:4.30},
          williamhill:{p1:1.21,p2:4.70},betway:{p1:1.22,p2:4.55},bwin:{p1:1.23,p2:4.40}},
  },
  {
    id:8, circuit:"WTA", level:"WTA 1000", tournament:"Indian Wells Masters (WTA)", surface:"Hard", round:"R16",
    status:"PRE", game:"-", point:"-", startTime:"Today 22:00", updated:Date.now()-600000,
    p1:{...BP,name:"E. Svitolina",rank:9,flag:"🇺🇦",age:30,hand:"R",
      aces:2,df:2,first_pct:63,first_won:66,second_won:52,bp_saved:65,bp_faced:4,service_games:7,return_pts_won:44,
      tiebreak_wr:0.58,third_set_wr:0.62,bp_convert:48,style:"counter",
      fatigue:0.16,momentum:0.3,h2h:"2-1",recent_form:[1,0,1,1,0],
      surface_wr:0.68,travel_hrs:11,last_match_days:2,altitude_delta:450,sleep_zone_diff:11},
    p2:{...BP,name:"K. Siniakova",rank:44,flag:"🇨🇿",age:28,hand:"R",
      aces:2,df:2,first_pct:62,first_won:65,second_won:49,bp_saved:58,bp_faced:4,service_games:7,return_pts_won:42,
      tiebreak_wr:0.52,third_set_wr:0.54,bp_convert:44,style:"allcourt",
      fatigue:0.12,momentum:0.4,h2h:"1-2",recent_form:[1,1,0,1,0],
      surface_wr:0.60,travel_hrs:11,last_match_days:2,altitude_delta:450,sleep_zone_diff:9},
    odds:{pinnacle:{p1:1.60,p2:2.42},epicbet:{p1:1.63,p2:2.35},bet365:{p1:1.65,p2:2.30},unibet:{p1:1.68,p2:2.25},
          williamhill:{p1:1.61,p2:2.40},betway:{p1:1.64,p2:2.32},bwin:{p1:1.62,p2:2.38}},
  },
  // ════ CHALLENGERS ════
  {
    id:9, circuit:"CH", level:"Challenger 50", tournament:"Cap Cana Challenger", surface:"Clay", round:"R16",
    status:"PRE", game:"-", point:"-", startTime:"Today 19:00", updated:Date.now()-660000,
    p1:{...BP,name:"C. Garin",rank:90,flag:"🇨🇱",age:27,hand:"R",
      tiebreak_wr:0.50,third_set_wr:0.54,bp_convert:42,style:"baseline",
      fatigue:0.14,momentum:0.3,h2h:"2-1",recent_form:[0,1,1,0,1],
      surface_wr:0.63,travel_hrs:6,last_match_days:2,altitude_delta:0,sleep_zone_diff:1},
    p2:{...BP,name:"J. Svrcina",rank:109,flag:"🇨🇿",age:19,hand:"R",
      tiebreak_wr:0.48,third_set_wr:0.48,bp_convert:38,style:"aggressive",
      fatigue:0.08,momentum:0.5,h2h:"1-2",recent_form:[1,1,0,1,0],
      surface_wr:0.52,travel_hrs:11,last_match_days:2,altitude_delta:0,sleep_zone_diff:5},
    odds:{pinnacle:{p1:1.70,p2:2.22},epicbet:{p1:1.74,p2:2.16},bet365:{p1:1.75,p2:2.15},unibet:{p1:1.78,p2:2.10},
          williamhill:{p1:1.72,p2:2.20},betway:{p1:1.74,p2:2.14},bwin:{p1:1.76,p2:2.12}},
  },
  {
    id:10, circuit:"CH", level:"Challenger 50", tournament:"Cap Cana Challenger", surface:"Clay", round:"R16",
    status:"PRE", game:"-", point:"-", startTime:"Today 22:30", updated:Date.now()-720000,
    p1:{...BP,name:"R. Bautista-Agut",rank:93,flag:"🇪🇸",age:36,hand:"R",
      tiebreak_wr:0.52,third_set_wr:0.56,bp_convert:42,style:"counter",
      fatigue:0.22,momentum:0.2,h2h:"4-2",recent_form:[1,0,1,0,1],
      surface_wr:0.66,travel_hrs:9,last_match_days:2,altitude_delta:0,sleep_zone_diff:6},
    p2:{...BP,name:"D. Goffin",rank:143,flag:"🇧🇪",age:33,hand:"R",
      tiebreak_wr:0.54,third_set_wr:0.52,bp_convert:40,style:"allcourt",
      fatigue:0.18,momentum:0.3,h2h:"2-4",recent_form:[0,1,1,0,0],
      surface_wr:0.57,travel_hrs:9,last_match_days:2,altitude_delta:0,sleep_zone_diff:6},
    odds:{pinnacle:{p1:1.65,p2:2.32},epicbet:{p1:1.68,p2:2.25},bet365:{p1:1.70,p2:2.22},unibet:{p1:1.73,p2:2.18},
          williamhill:{p1:1.66,p2:2.30},betway:{p1:1.69,p2:2.22},bwin:{p1:1.67,p2:2.28}},
  },
  {
    id:11, circuit:"CH", level:"Challenger 75", tournament:"Phoenix Open Challenger", surface:"Hard", round:"R16",
    status:"PRE", game:"-", point:"-", startTime:"Today 18:00", updated:Date.now()-780000,
    p1:{...BP,name:"Q. Halys",rank:102,flag:"🇫🇷",age:28,hand:"R",
      tiebreak_wr:0.50,third_set_wr:0.52,bp_convert:40,style:"serve-dom",
      fatigue:0.12,momentum:0.3,h2h:"2-1",recent_form:[1,0,1,1,0],
      surface_wr:0.58,travel_hrs:9,last_match_days:2,altitude_delta:0,sleep_zone_diff:9},
    p2:{...BP,name:"S. Travaglia",rank:166,flag:"🇮🇹",age:32,hand:"R",
  ...
  },
  {
    ...
    status:"PRE", game:"-", point:"-", startTime:"Today 14:00", updated:Date.now()-840000,
    p1:{...BP,name:"C. Holmgren",rank:201,flag:"🇺🇸",age:24,hand:"R",
      tiebreak_wr:0.48,third_set_wr:0.50,bp_convert:37,style:"serve-dom",
      fatigue:0.10,momentum:0.2,h2h:"0-0",recent_form:[1,0,1,0,1],
      surface_wr:0.55,travel_hrs:9,last_match_days:2,altitude_delta:0,sleep_zone_diff:9},
    p2:{...BP,name:"L. Faurel",rank:405,flag:"🇫🇷",age:22,hand:"R",
      tiebreak_wr:0.40,third_set_wr:0.38,bp_convert:30,style:"baseline",
      fatigue:0.06,momentum:0.3,h2h:"0-0",recent_form:[0,1,0,1,0],
      surface_wr:0.44,travel_hrs:2,last_match_days:2,altitude_delta:0,sleep_zone_diff:0},
    odds:{pinnacle:{p1:1.48,p2:2.78},epicbet:{p1:1.52,p2:2.68},bet365:{p1:1.55,p2:2.60},unibet:{p1:1.57,p2:2.55},
          williamhill:{p1:1.50,p2:2.74},betway:{p1:1.53,p2:2.65},bwin:{p1:1.51,p2:2.72}},
  },
  {
    id:13, circuit:"CH", level:"Challenger 50", tournament:"Santiago Challenger", surface:"Clay", round:"R16",
    status:"PRE", game:"-", point:"-", startTime:"Today 22:00", updated:Date.now()-900000,
    p1:{...BP,name:"F. Agamenone",rank:269,flag:"🇮🇹",age:31,hand:"R",
      tiebreak_wr:0.48,third_set_wr:0.52,bp_convert:38,style:"baseline",
      fatigue:0.14,momentum:0.2,h2h:"1-0",recent_form:[1,0,1,0,1],
      surface_wr:0.56,travel_hrs:14,last_match_days:2,altitude_delta:500,sleep_zone_diff:4},
    p2:{...BP,name:"J. Bueno",rank:213,flag:"🇪🇸",age:22,hand:"R",
      tiebreak_wr:0.50,third_set_wr:0.50,bp_convert:38,style:"allcourt",
      fatigue:0.08,momentum:0.4,h2h:"0-1",recent_form:[1,1,0,0,1],
      surface_wr:0.54,travel_hrs:3,last_match_days:2,altitude_delta:500,sleep_zone_diff:5},
    odds:{pinnacle:{p1:1.88,p2:1.98},epicbet:{p1:1.92,p2:1.94},bet365:{p1:1.95,p2:1.92},unibet:{p1:1.90,p2:1.96},
          williamhill:{p1:1.86,p2:2.02},betway:{p1:1.90,p2:1.98},bwin:{p1:1.93,p2:1.93}},
  },
  // ════ AUSTIN WTA CHALLENGER ════
  {
    id:14, circuit:"WTA", level:"WTA Challenger", tournament:"Austin Challenger (WTA)", surface:"Hard", round:"R16",
    status:"PRE", game:"-", point:"-", startTime:"Today 17:00", updated:Date.now()-960000,
    p1:{...BP,name:"B. Andreescu",rank:165,flag:"🇨🇦",age:24,hand:"R",
      tiebreak_wr:0.54,third_set_wr:0.58,bp_convert:46,style:"aggressive",
      fatigue:0.16,momentum:0.4,h2h:"1-0",recent_form:[1,1,0,1,0],
      surface_wr:0.62,travel_hrs:4,last_match_days:2,altitude_delta:150,sleep_zone_diff:1},
    p2:{...BP,name:"R. Zarazua",rank:89,flag:"🇲🇽",age:25,hand:"R",
      tiebreak_wr:0.46,third_set_wr:0.48,bp_convert:38,style:"aggressive",
      fatigue:0.08,momentum:0.5,h2h:"0-1",recent_form:[1,0,1,1,0],
      surface_wr:0.57,travel_hrs:1,last_match_days:2,altitude_delta:150,sleep_zone_diff:0},
    odds:{pinnacle:{p1:1.75,p2:2.15},epicbet:{p1:1.78,p2:2.10},bet365:{p1:1.80,p2:2.08},unibet:{p1:1.83,p2:2.04},
          williamhill:{p1:1.76,p2:2.14},betway:{p1:1.78,p2:2.10},bwin:{p1:1.80,p2:2.06}},
  },
  {
    id:15, circuit:"WTA", level:"WTA Challenger", tournament:"Austin Challenger (WTA)", surface:"Hard", round:"R16",
    status:"PRE", game:"-", point:"-", startTime:"Today 17:00", updated:Date.now()-1020000,
    p1:{...BP,name:"C. McNally",rank:68,flag:"🇺🇸",age:22,hand:"R",
      tiebreak_wr:0.52,third_set_wr:0.54,bp_convert:44,style:"allcourt",
      fatigue:0.10,momentum:0.4,h2h:"2-0",recent_form:[1,1,0,1,0],
      surface_wr:0.65,travel_hrs:0,last_match_days:2,altitude_delta:150,sleep_zone_diff:0},
    p2:{...BP,name:"M. Tararudee",rank:124,flag:"🇹🇭",age:22,hand:"R",
  ...
  },
  {
    ...
    status:"PRE", game:"-", point:"-", startTime:"Today 18:30", updated:Date.now()-1080000,
    p1:{...BP,name:"M. Kessler",rank:51,flag:"🇺🇸",age:23,hand:"R",
      tiebreak_wr:0.55,third_set_wr:0.57,bp_convert:46,style:"aggressive",
      fatigue:0.08,momentum:0.5,h2h:"1-0",recent_form:[1,1,1,0,1],
      surface_wr:0.67,travel_hrs:0,last_match_days:2,altitude_delta:150,sleep_zone_diff:0},
    p2:{...BP,name:"K. Juvan",rank:92,flag:"🇸🇮",age:24,hand:"R",
  ...
  },
  {
    ...
    status:"PRE", game:"-", point:"-", startTime:"Today 22:00", updated:Date.now()-1140000,
    p1:{...BP,name:"A. Sun",rank:100,flag:"🇹🇼",age:22,hand:"R",
      tiebreak_wr:0.48,third_set_wr:0.50,bp_convert:38,style:"allcourt",
      fatigue:0.10,momentum:0.4,h2h:"0-1",recent_form:[1,1,0,0,1],
      surface_wr:0.57,travel_hrs:14,last_match_days:2,altitude_delta:150,sleep_zone_diff:14},
    p2:{...BP,name:"P. Badosa",rank:106,flag:"🇪🇸",age:27,hand:"R",
      tiebreak_wr:0.52,third_set_wr:0.55,bp_convert:42,style:"aggressive",
      fatigue:0.14,momentum:0.3,h2h:"1-0",recent_form:[0,1,1,0,1],
      surface_wr:0.60,travel_hrs:9,last_match_days:2,altitude_delta:150,sleep_zone_diff:9},
    odds:{pinnacle:{p1:1.90,p2:1.96},epicbet:{p1:1.95,p2:1.90},bet365:{p1:1.98,p2:1.88},unibet:{p1:1.92,p2:1.94},
          williamhill:{p1:1.88,p2:2.00},betway:{p1:1.93,p2:1.93},bwin:{p1:1.96,p2:1.90}},
  },
];
