...
const MOCK_MATCHES = [
  ...
  },
  {
    ...
    p1:{...BP,name:"J. Sinner",rank:1,flag:"🇮🇹",age:23,hand:"R",
      ...
      fatigue:0.20,momentum:0.3,h2h:"5-2",recent_form:[1,1,1,1,0],
      surface_wr:0.80,travel_hrs:11,last_match_days:1,altitude_delta:450,sleep_zone_diff:9},
    p2:{...BP,name:"A. De Minaur",rank:10,flag:"🇦🇺",age:25,hand:"R",
      aces:3,df:3,first_pct:64,first_won:69,second_won:46,bp_saved:62,bp_faced:4,service_games:8,return_pts_won:42,
      tiebreak_wr:0.55,third_set_wr:0.60,bp_convert:46,style:"counter",
      fatigue:0.18,momentum:-0.1,h2h:"2-5",recent_form:[1,1,0,1,1],
      surface_wr:0.68,travel_hrs:15,last_match_days:1,altitude_delta:450,sleep_zone_diff:18},
    odds:{pinnacle:{p1:1.32,p2:3.40},epicbet:{p1:1.34,p2:3.28},bet365:{p1:1.35,p2:3.20},unibet:{p1:1.36,p2:3.15},
          williamhill:{p1:1.33,p2:3.35},betway:{p1:1.34,p2:3.25},bwin:{p1:1.35,p2:3.18}},
  },
  {
  ...
  {
    id:7, circuit:"ATP", level:"Masters 1000", tournament:"Indian Wells Masters", surface:"Hard", round:"R32",
    status:"PRE", game:"-", point:"-", startTime:"Mar 11, 14:00", updated:Date.now()-900000,
    p1:{...BP,name:"D. Medvedev",rank:5,flag:"🇷🇺",age:29,hand:"R",
      tiebreak_wr:0.72,third_set_wr:0.58,bp_convert:42,style:"counter",
      fatigue:0.14,momentum:0.3,h2h:"4-3",recent_form:[1,0,1,1,1],
      surface_wr:0.71,travel_hrs:11,last_match_days:2,altitude_delta:450,sleep_zone_diff:9},
    p2:{...BP,name:"F. Auger-Aliassime",rank:19,flag:"🇨🇦",age:24,hand:"R",
      tiebreak_wr:0.54,third_set_wr:0.52,bp_convert:40,style:"serve-dom",
      fatigue:0.10,momentum:0.4,h2h:"3-4",recent_form:[1,1,0,1,0],
      surface_wr:0.62,travel_hrs:4,last_match_days:2,altitude_delta:450,sleep_zone_diff:3},
    odds:{pinnacle:{p1:1.55,p2:2.55},epicbet:{p1:1.58,p2:2.50},bet365:{p1:1.60,p2:2.45},unibet:{p1:1.62,p2:2.40},
          williamhill:{p1:1.56,p2:2.52},betway:{p1:1.59,p2:2.47},bwin:{p1:1.57,p2:2.50}},
  },
  {
    id:8, circuit:"CH", level:"Challenger 125", tournament:"Marrakech Open Challenger", surface:"Clay", round:"R16",
    status:"PRE", game:"-", point:"-", startTime:"Mar 11, 12:00", updated:Date.now()-1200000,
    p1:{...BP,name:"T. Griekspoor",rank:28,flag:"🇳🇱",age:28,hand:"R",
      tiebreak_wr:0.58,third_set_wr:0.55,bp_convert:44,style:"aggressive",
      fatigue:0.10,momentum:0.5,h2h:"2-1",recent_form:[1,1,0,1,1],
      surface_wr:0.54,travel_hrs:3,last_match_days:2,altitude_delta:450,sleep_zone_diff:1},
    p2:{...BP,name:"M. Giron",rank:41,flag:"🇺🇸",age:30,hand:"R",
      tiebreak_wr:0.50,third_set_wr:0.48,bp_convert:38,style:"baseline",
      fatigue:0.14,momentum:0.2,h2h:"1-2",recent_form:[0,1,1,0,1],
      surface_wr:0.51,travel_hrs:10,last_match_days:2,altitude_delta:450,sleep_zone_diff:9},
    odds:{pinnacle:{p1:1.62,p2:2.40},epicbet:{p1:1.65,p2:2.35},bet365:{p1:1.68,p2:2.28},unibet:{p1:1.70,p2:2.22},
          williamhill:{p1:1.63,p2:2.38},betway:{p1:1.66,p2:2.30},bwin:{p1:1.68,p2:2.25}},
  },
  {
    id:9, circuit:"CH", level:"Challenger 50", tournament:"Kobe Indoor Challenger", surface:"Hard", round:"R16",
    status:"PRE", game:"-", point:"-", startTime:"Mar 11, 09:00", updated:Date.now()-1800000,
    p1:{...BP,name:"B. van de Zandschulp",rank:45,flag:"🇳🇱",age:29,hand:"R",
      tiebreak_wr:0.51,third_set_wr:0.52,bp_convert:40,style:"allcourt",
      fatigue:0.12,momentum:0.3,h2h:"1-0",recent_form:[1,0,1,1,0],
      surface_wr:0.56,travel_hrs:12,last_match_days:2,altitude_delta:0,sleep_zone_diff:9},
    p2:{...BP,name:"Y. Watanuki",rank:82,flag:"🇯🇵",age:26,hand:"R",
      tiebreak_wr:0.50,third_set_wr:0.50,bp_convert:36,style:"baseline",
      fatigue:0.06,momentum:0.5,h2h:"0-1",recent_form:[1,1,0,1,1],
      surface_wr:0.58,travel_hrs:0,last_match_days:2,altitude_delta:0,sleep_zone_diff:0},
    odds:{pinnacle:{p1:1.68,p2:2.28},epicbet:{p1:1.72,p2:2.20},bet365:{p1:1.75,p2:2.15},unibet:{p1:1.74,p2:2.18},
          williamhill:{p1:1.70,p2:2.22},betway:{p1:1.72,p2:2.18},bwin:{p1:1.75,p2:2.12}},
  },
  {
    ...
    p1:{...BP,name:"S. Wawrinka",rank:42,flag:"🇨🇭",age:40,hand:"R",
      ...
      fatigue:0.22,momentum:0.5,h2h:"1-1",recent_form:[0,1,1,1,0],
      surface_wr:0.60,travel_hrs:11,last_match_days:1,altitude_delta:450,sleep_zone_diff:9},
    p2:{...BP,name:"B. Nakashima",rank:38,flag:"🇺🇸",age:23,hand:"R",
      aces:3,df:2,first_pct:65,first_won:69,second_won:48,bp_saved:68,bp_faced:4,service_games:10,return_pts_won:40,
      tiebreak_wr:0.50,third_set_wr:0.52,bp_convert:42,style:"serve-dom",
      fatigue:0.10,momentum:-0.2,h2h:"1-1",recent_form:[1,0,1,0,1],
      surface_wr:0.64,travel_hrs:0,last_match_days:2,altitude_delta:450,sleep_zone_diff:0},
    odds:{pinnacle:{p1:1.88,p2:1.98},epicbet:{p1:1.92,p2:1.96},bet365:{p1:2.00,p2:1.90},unibet:{p1:1.94,p2:1.94},
          williamhill:{p1:1.86,p2:2.02},betway:{p1:1.90,p2:1.98},bwin:{p1:1.87,p2:2.08}},
  },
  {
  ...
  // ── New matches v5.0 ──────────────────────────────
  {
    id:12, circuit:"ATP", level:"Masters 1000", tournament:"Indian Wells Masters", surface:"Hard", round:"R16",
    status:"PRE", game:"-", point:"-", startTime:"Tomorrow 19:30", updated:Date.now()-3600000,
    p1:{...BP,name:"N. Djokovic",rank:7,flag:"🇷🇸",age:37,hand:"R",
      tiebreak_wr:0.69,third_set_wr:0.74,bp_convert:55,style:"counter",
      fatigue:0.18,momentum:0.4,h2h:"6-3",recent_form:[1,1,0,1,1],
      surface_wr:0.74,travel_hrs:11,last_match_days:2,altitude_delta:450,sleep_zone_diff:9},
    p2:{...BP,name:"T. Machac",rank:33,flag:"🇨🇿",age:23,hand:"R",
      tiebreak_wr:0.52,third_set_wr:0.50,bp_convert:40,style:"aggressive",
      fatigue:0.12,momentum:0.6,h2h:"0-2",recent_form:[1,1,1,0,1],
      surface_wr:0.60,travel_hrs:11,last_match_days:2,altitude_delta:450,sleep_zone_diff:9},
    odds:{pinnacle:{p1:1.44,p2:2.82},epicbet:{p1:1.47,p2:2.74},bet365:{p1:1.48,p2:2.70},unibet:{p1:1.50,p2:2.65},
          williamhill:{p1:1.45,p2:2.80},betway:{p1:1.46,p2:2.76},bwin:{p1:1.48,p2:2.68}},
  },
  {
    id:13, circuit:"WTA", level:"WTA 1000", tournament:"Indian Wells Masters (WTA)", surface:"Hard", round:"R16",
    ...
    p1:{...BP,name:"I. Swiatek",rank:2,flag:"🇵🇱",age:23,hand:"R",
      ...
      fatigue:0.10,momentum:0.6,h2h:"5-2",recent_form:[1,1,1,1,1],
      surface_wr:0.79,travel_hrs:11,last_match_days:2,altitude_delta:450,sleep_zone_diff:9},
    p2:{...BP,name:"M. Keys",rank:11,flag:"🇺🇸",age:29,hand:"R",
      tiebreak_wr:0.52,third_set_wr:0.55,bp_convert:44,style:"aggressive",
      fatigue:0.08,momentum:0.5,h2h:"2-5",recent_form:[1,1,0,1,0],
      surface_wr:0.68,travel_hrs:0,last_match_days:2,altitude_delta:450,sleep_zone_diff:0},
    odds:{pinnacle:{p1:1.48,p2:2.80},epicbet:{p1:1.52,p2:2.70},bet365:{p1:1.54,p2:2.65},unibet:{p1:1.55,p2:2.62},
          williamhill:{p1:1.49,p2:2.78},betway:{p1:1.51,p2:2.72},bwin:{p1:1.50,p2:2.75}},
  },
  {
  ...
  },
  {
    ...
    p1:{...BP,name:"C. Gauff",rank:3,flag:"🇺🇸",age:21,hand:"R",
      ...
      fatigue:0.10,momentum:0.4,h2h:"3-2",recent_form:[1,1,0,1,1],
      surface_wr:0.72,travel_hrs:0,last_match_days:2,altitude_delta:450,sleep_zone_diff:0},
    p2:{...BP,name:"E. Rybakina",rank:5,flag:"🇰🇿",age:25,hand:"R",
      ...
      fatigue:0.14,momentum:-0.1,h2h:"2-3",recent_form:[1,1,1,0,1],
      surface_wr:0.76,travel_hrs:11,last_match_days:1,altitude_delta:450,sleep_zone_diff:9},
    odds:{pinnacle:{p1:1.64,p2:2.38},epicbet:{p1:1.67,p2:2.32},bet365:{p1:1.70,p2:2.28},unibet:{p1:1.72,p2:2.22},
          williamhill:{p1:1.65,p2:2.35},betway:{p1:1.68,p2:2.28},bwin:{p1:1.66,p2:2.38}},
  },
  {
  ...
  {
    id:19, circuit:"CH", level:"Challenger 125", tournament:"Marrakech Open Challenger", surface:"Clay", round:"R32",
    status:"PRE", game:"-", point:"-", startTime:"Mar 11, 10:00", updated:Date.now()-3600000,
    p1:{...BP,name:"H. Rune",rank:17,flag:"🇩🇰",age:21,hand:"R",
      tiebreak_wr:0.56,third_set_wr:0.58,bp_convert:46,style:"aggressive",
      fatigue:0.08,momentum:0.6,h2h:"2-0",recent_form:[1,1,1,1,0],
      surface_wr:0.62,travel_hrs:3,last_match_days:4,altitude_delta:450,sleep_zone_diff:1},
    p2:{...BP,name:"S. Kwon",rank:72,flag:"🇰🇷",age:29,hand:"R",
      tiebreak_wr:0.48,third_set_wr:0.46,bp_convert:36,style:"baseline",
      fatigue:0.12,momentum:0.2,h2h:"0-2",recent_form:[0,1,0,1,1],
      surface_wr:0.48,travel_hrs:12,last_match_days:2,altitude_delta:450,sleep_zone_diff:8},
    odds:{pinnacle:{p1:1.28,p2:3.80},epicbet:{p1:1.30,p2:3.65},bet365:{p1:1.32,p2:3.55},unibet:{p1:1.33,p2:3.48},
          williamhill:{p1:1.29,p2:3.75},betway:{p1:1.31,p2:3.60},bwin:{p1:1.30,p2:3.70}},
  },
  {
  ...
  },
  {
    ...
    p1:{...BP,name:"J. Mensik",rank:24,flag:"🇨🇿",age:19,hand:"R",
      ...
      fatigue:0.12,momentum:0.5,h2h:"1-0",recent_form:[1,1,1,0,1],
      surface_wr:0.62,travel_hrs:11,last_match_days:2,altitude_delta:450,sleep_zone_diff:9},
    p2:{...BP,name:"A. Bublik",rank:30,flag:"🇰🇿",age:27,hand:"R",
      aces:9,df:4,first_pct:65,first_won:74,second_won:42,bp_saved:55,bp_faced:5,service_games:11,return_pts_won:36,
      tiebreak_wr:0.62,third_set_wr:0.48,bp_convert:38,style:"serve-dom",
      fatigue:0.16,momentum:-0.3,h2h:"0-1",recent_form:[0,1,0,1,0],
      surface_wr:0.58,travel_hrs:11,last_match_days:1,altitude_delta:450,sleep_zone_diff:9},
    odds:{pinnacle:{p1:1.80,p2:2.10},epicbet:{p1:1.85,p2:2.04},bet365:{p1:1.87,p2:2.02},unibet:{p1:1.88,p2:2.00},
          williamhill:{p1:1.78,p2:2.12},betway:{p1:1.82,p2:2.06},bwin:{p1:1.86,p2:2.00}},
  },
  {
